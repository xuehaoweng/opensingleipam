...
class ApiKeyToken(models.Model):
    ...
    platform = models.CharField(max_length=40, verbose_name='api-key运用平台', default='netops', unique=True)
    ...
    expireTime = models.DateTimeField(blank=True, null=True, verbose_name='key过期时间')
